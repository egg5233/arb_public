...
import type { Position, Opportunity, Stats, Alert, LogEntry, RejectedOpportunity, SpotPosition, SpotOpportunity, LossLimitStatus, AgreementBlock } from '../types.ts';
...
export function useWebSocket(enabled: boolean) {
  ...
  const [agreementBlocks, setAgreementBlocks] = useState<AgreementBlock[]>([]);
        ...
        try {
          ...
          switch (msg.type) {
            ...
            case 'loss_limits':
              ...
              break;
            case 'agreement_blocks':
              setAgreementBlocks((msg.data as AgreementBlock[]) || []);
              break;
          }
        } catch {
          // ignore parse errors
  ...
  return { connected, positions, setPositions, opportunities, setOpportunities, alerts, stats, setStats, logs, setLogs, rejections, setRejections, spotPositions, setSpotPositions, spotOpportunities, setSpotOpportunities, lossLimits, agreementBlocks, setAgreementBlocks };
}
