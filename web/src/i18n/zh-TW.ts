...
const zhTW: Record<TranslationKey, string> = {
  ...
  'pricegap.masterEnableTooltip': '價差套利追蹤器主開關。變更會透過儀表板設定 API 保存。',
  'pricegap.paperMode': '模擬模式',
  'pricegap.paperModeTooltip': '啟用時，新開倉為模擬交易。現有持倉保留原始模式。',
  'pricegap.paperOn': '模擬',
  'pricegap.liveOn': '實盤',
  'pricegap.debugLog': '偵錯記錄',
  'pricegap.debugLogTooltip': '開啟後，追蹤器會記錄每個候選未觸發的原因 (sample_error、insufficient_persistence、stale_bbo)。每個（候選, 原因）每 60 秒最多一筆。',
  ...
  'pricegap.discovery.banner.disabled.body': '可直接從此儀表板啟動掃描器。下一個週期將自動填入資料。',
  'pricegap.discovery.banner.disabled.enableButton': '啟用自動發現',
  'pricegap.discovery.banner.disabled.enabling': '啟用中…',
  ...
  'pricegap.discovery.scoreHistory.noUniverse': '請在策略 4 設定中加入標的，以填入分數歷史。',
  ...
  'pricegap.ramp.actionReason': '爬坡操作原因',
  'pricegap.ramp.actionReasonPlaceholder': '重設、強制升級或強制降級皆必填',
  'pricegap.ramp.resetButton': '重設爬坡',
  'pricegap.ramp.forcePromoteButton': '強制升級',
  'pricegap.ramp.forceDemoteButton': '強制降級',
  'pricegap.ramp.confirmResetTitle': '確認重設爬坡',
  'pricegap.ramp.confirmResetPrompt': "輸入 'RESET-RAMP' 將爬坡重設到階段 1:",
  'pricegap.ramp.confirmPromoteTitle': '確認強制升級',
  'pricegap.ramp.confirmPromotePrompt': "輸入 'FORCE-PROMOTE' 將爬坡提升一階:",
  'pricegap.ramp.confirmDemoteTitle': '確認強制降級',
  'pricegap.ramp.confirmDemotePrompt': "輸入 'FORCE-DEMOTE' 將爬坡降低一階:",
  'pricegap.ramp.confirmSubmit': '確認',
  ...
  'pricegap.reconcile.runDate': '對帳日期',
  'pricegap.reconcile.runButton': '執行對帳',
  'pricegap.reconcile.running': '執行中…',
  ...
  'pricegap.config.ramp.readOnlyNote': '爬坡參數可直接由此儀表板管理。',
  ...
  'pricegap.config.scanner.maxUniverse.label': '宇宙數量',
  'pricegap.config.scanner.maxUniverse.help': '目前設定、每次掃描會評估的交易對數量。',
  'pricegap.config.scanner.universe.label': '自動發現宇宙',
  'pricegap.config.scanner.universe.help': '以逗號或換行分隔交易對，例如 BTCUSDT。最多 20 個。',
  'pricegap.config.scanner.denylist.label': '自動發現排除清單',
  'pricegap.config.scanner.denylist.help': '可選的 symbol 或 symbol@exchange 項目，掃描時略過。',
  'pricegap.config.scanner.thresholdBps.label': '發現門檻 (bps)',
  'pricegap.config.scanner.thresholdBps.help': '原始價差最低門檻。下限 10 bps。',
  'pricegap.config.scanner.minDepth.label': '最小深度 (USDT)',
  'pricegap.config.scanner.minDepth.help': '評分所需的最小可用訂單簿深度。',
  ...
  'pricegap.config.ramp.stage1.label': '階段 1 大小 (USDT)',
  'pricegap.config.ramp.stage1.help': '爬坡階段 1 的單腿名目金額。',
  'pricegap.config.ramp.stage2.label': '階段 2 大小 (USDT)',
  'pricegap.config.ramp.stage2.help': '爬坡階段 2 的單腿名目金額。',
  'pricegap.config.ramp.stage3.label': '階段 3 大小 (USDT)',
  'pricegap.config.ramp.stage3.help': '爬坡階段 3 的單腿名目金額。',
  'pricegap.config.ramp.hardCeiling.label': '硬上限 (USDT/腿)',
  'pricegap.config.ramp.hardCeiling.help': '實盤資金爬坡允許的單腿最大金額。',
  'pricegap.config.ramp.cleanDays.label': '升級所需無異常天數',
  'pricegap.config.ramp.cleanDays.help': '自動升級前需要連續通過對帳的天數。',
  // 已遷移閘門欄位
