const en = {
  ...
  'cfg.sf.enableSpotOnlyExchanges': 'Spot-only Exchanges',
  'cfg.sf.enableSpotOnlyExchangesDesc': 'Allow Dir B buy-spot/short-futures entries on exchanges that support spot trading but not spot margin. Default OFF.',
  ...
  'pricegap.masterEnableTooltip': 'Master on/off for price-gap tracker. Persists through the dashboard config API.',
  ...
  'pricegap.debugLogTooltip': 'When ON, the tracker logs the reason every candidate did not fire (sample_error, insufficient_persistence, stale_bbo). Rate-limited to one line per (candidate, reason) per 60s.',
  ...
  'pricegap.candidates.modal.direction.label': 'Direction',
  'pricegap.candidates.modal.direction.option.pinned': 'Pinned (configured side only)',
  'pricegap.candidates.modal.direction.option.bidirectional': 'Bidirectional (fire on either sign)',
  'pricegap.candidates.modal.direction.help': 'Pinned: only fire when long_exch is cheaper. Bidirectional: also fire when short_exch is cheaper, swapping leg roles on the wire.',
  'pricegap.candidates.modal.direction.validation.invalid': 'Direction must be "pinned" or "bidirectional"',
  ...
  'pricegap.candidates.errors.thresholdRange': 'Threshold must be 1–10000 bps',
  'pricegap.candidates.errors.maxPositionRange': 'Max position must be 1–500000 USDT',
  'pricegap.candidates.errors.slippageRange': 'Modeled slippage must be 0–1000 bps',
  ...
  'pricegap.discovery.banner.disabled.body': 'Start the scanner from this dashboard. The section will populate on the next cycle.',
  'pricegap.discovery.banner.disabled.enableButton': 'Enable Discovery',
  'pricegap.discovery.banner.disabled.enabling': 'Enabling…',
  ...
  'pricegap.discovery.scoreHistory.noUniverse': 'Add symbols in Strategy 4 Configuration to populate the score history.',
  ...
  'pricegap.ramp.actionReason': 'Ramp action reason',
  'pricegap.ramp.actionReasonPlaceholder': 'Required for reset, promote, or demote',
  'pricegap.ramp.resetButton': 'Reset Ramp',
  'pricegap.ramp.forcePromoteButton': 'Force Promote',
  'pricegap.ramp.forceDemoteButton': 'Force Demote',
  'pricegap.ramp.confirmResetTitle': 'Confirm Ramp Reset',
  'pricegap.ramp.confirmResetPrompt': "Type 'RESET-RAMP' to reset the ramp to stage 1:",
  'pricegap.ramp.confirmPromoteTitle': 'Confirm Force Promote',
  'pricegap.ramp.confirmPromotePrompt': "Type 'FORCE-PROMOTE' to promote the ramp by one stage:",
  'pricegap.ramp.confirmDemoteTitle': 'Confirm Force Demote',
  'pricegap.ramp.confirmDemotePrompt': "Type 'FORCE-DEMOTE' to demote the ramp by one stage:",
  'pricegap.ramp.confirmSubmit': 'Confirm',
  ...
  'pricegap.reconcile.runDate': 'Reconcile date',
  'pricegap.reconcile.runButton': 'Run Reconcile',
  'pricegap.reconcile.running': 'Running…',
  ...
  'pricegap.config.ramp.readOnlyNote': 'Ramp parameters are managed from this dashboard.',
  ...
  'pricegap.config.scanner.maxUniverse.label': 'Universe count',
  'pricegap.config.scanner.maxUniverse.help': 'Configured symbols evaluated per scan.',
  'pricegap.config.scanner.universe.label': 'Discovery universe',
  'pricegap.config.scanner.universe.help': 'Comma or newline separated symbols, e.g. BTCUSDT. Max 20.',
  'pricegap.config.scanner.denylist.label': 'Discovery denylist',
  'pricegap.config.scanner.denylist.help': 'Optional symbols or symbol@exchange entries to skip.',
  'pricegap.config.scanner.thresholdBps.label': 'Discovery threshold (bps)',
  'pricegap.config.scanner.thresholdBps.help': 'Minimum raw price-gap threshold. Floor 10 bps.',
  'pricegap.config.scanner.minDepth.label': 'Minimum depth (USDT)',
  'pricegap.config.scanner.minDepth.help': 'Minimum available orderbook depth required for scoring.',
  ...
  'pricegap.config.ramp.stage1.label': 'Stage 1 size (USDT)',
  'pricegap.config.ramp.stage1.help': 'Per-leg notional for ramp stage 1.',
  'pricegap.config.ramp.stage2.label': 'Stage 2 size (USDT)',
  'pricegap.config.ramp.stage2.help': 'Per-leg notional for ramp stage 2.',
  'pricegap.config.ramp.stage3.label': 'Stage 3 size (USDT)',
  'pricegap.config.ramp.stage3.help': 'Per-leg notional for ramp stage 3.',
  'pricegap.config.ramp.hardCeiling.label': 'Hard ceiling (USDT/leg)',
  'pricegap.config.ramp.hardCeiling.help': 'Maximum per-leg size allowed by the live-capital ramp.',
  'pricegap.config.ramp.cleanDays.label': 'Clean days to promote',
  'pricegap.config.ramp.cleanDays.help': 'Consecutive clean reconcile days required before auto-promotion.',
